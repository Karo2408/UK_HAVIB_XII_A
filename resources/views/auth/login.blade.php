      ...
      <div class="col-md-8 col-lg-6 col-xxl-3">
        <div class="card mb-0">
          <div class="card-header">
            <img src="{{ asset('assets/images/logos/PPS.png') }}" width="180" alt="SS Mart Logo">
          </div>
          <div class="card-body">
            <p class="text-center">Silakan login ke SS Mart</p>
            <form method="POST" action="{{ route('login.post') }}">
              ...
              <button type="submit" class="btn btn-primary w-100 py-2 fs-5 mb-3 rounded-2">Masuk</button>
              </div>
            </form>
          </div>
        </div>
